...
public class Taller5 {
     ...
     */
    public static void ponderado(int estm, String[] estudiantes, float[] notasProy, float[] notasParcial, float[] notasExamen,double[] pond) {
        String[] op = {"opcion 1 \n (30, 30, 40).", "Opcion 2 \n (40, 40, 20)."};
    ...
    public static void SuperiorA3(int estm, String[] estudiantes, float[] notasProy, float[] notasParcial, float[] notasExamen,double[] pond){
        String[] aprobados = new String[estm];
        
        for (int i = 0; i < estm; i++) {
            double p = pond[i];
            if (p >= 3.0) {
                String app = estudiantes[p];
